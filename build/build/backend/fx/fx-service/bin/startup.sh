...
# config目录: 配置文件目录
# logs目录: 项目运行日志目录
# logs/shanghai-micro-service_startup.log: 记录启动日志
...
#==========================================================================================
JAVA_OPT="-server -Xms512m -Xmx512m -Xmn512m -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=1024m"
